...
function setup_labcas_data(datatype, query, dataset_query){
    console.log(localStorage.getItem('environment')+"/labcas-backend-data-access-api/collections/select?q="+query+"&wt=json&indent=true&rows=5000&sort=id%20asc");
    $.ajax({
        url: localStorage.getItem('environment')+"/labcas-backend-data-access-api/collections/select?q="+query+"&wt=json&indent=true&rows=5000&sort=id%20asc",
	...
	var url = localStorage.getItem('environment')+"/labcas-backend-data-access-api/datasets/select?q="+dataset_query+"&wt=json&indent=true&rows=5000";
        console.log(url);
        $.ajax({
	    url: url,
            beforeSend: function(xhr) {
